...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    //language=sql
    private final String SQL_INSERT_USER = "insert into blogger(first_name, last_name, login, password_hash) VALUES (?, ?, ?, ?)";
    private final String SQL_FIND_USER_BY_LOGIN = "SELECT * FROM blogger WHERE login=?;";
